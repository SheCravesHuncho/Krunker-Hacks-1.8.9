// ==UserScript==
// @name         Krunker Hacks by Ciborh
// @namespace    https://github.com/hrt
// @version      1.8.9
// @description  Krunker Hacks by Ciborh for VErsion 1.8.9
...
document.getElementById('modVote').innerHTML = 'YT: Ciborh';
document.getElementById("modVote").style.color = "Yellow";
// Adblock (Ads are sucks)
document.getElementById("krunkerio_728x90_1").remove();
// more shit
document.getElementById("aContainer").innerHTML = 'Follow CIborh on Youtube';
